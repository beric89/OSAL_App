...
${OBJECTDIR}/Windows/OSALInit.o: Windows/OSALInit.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/OSALInit.o Windows/OSALInit.c

${OBJECTDIR}/Windows/clock.o: Windows/clock.c
	${MKDIR} -p ${OBJECTDIR}/Windows
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/clock.o Windows/clock.c

${OBJECTDIR}/Windows/console.o: Windows/console.c
	${MKDIR} -p ${OBJECTDIR}/Windows
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/console.o Windows/console.c

${OBJECTDIR}/Windows/filesystem.o: Windows/filesystem.c
	${MKDIR} -p ${OBJECTDIR}/Windows
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/filesystem.o Windows/filesystem.c
...
${TESTDIR}/tests/test_OSAL_APIInit.o: tests/test_OSAL_APIInit.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_APIInit.o tests/test_OSAL_APIInit.c


${TESTDIR}/tests/test_OSAL_Close.o: tests/test_OSAL_Close.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Close.o tests/test_OSAL_Close.c


${TESTDIR}/tests/test_OSAL_Console_File_Open.o: tests/test_OSAL_Console_File_Open.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Console_File_Open.o tests/test_OSAL_Console_File_Open.c


${TESTDIR}/tests/test_OSAL_Create.o: tests/test_OSAL_Create.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Create.o tests/test_OSAL_Create.c


${TESTDIR}/tests/test_OSAL_Create_Directory.o: tests/test_OSAL_Create_Directory.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Create_Directory.o tests/test_OSAL_Create_Directory.c


${TESTDIR}/tests/test_OSAL_GetLocalTime.o: tests/test_OSAL_GetLocalTime.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_GetLocalTime.o tests/test_OSAL_GetLocalTime.c
...
${TESTDIR}/tests/test_OSAL_Printf.o: tests/test_OSAL_Printf.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Printf.o tests/test_OSAL_Printf.c


${TESTDIR}/tests/test_OSAL_PrintfDIsable.o: tests/test_OSAL_PrintfDIsable.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_PrintfDIsable.o tests/test_OSAL_PrintfDIsable.c


${TESTDIR}/tests/test_OSAL_PrintfEnable.o: tests/test_OSAL_PrintfEnable.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_PrintfEnable.o tests/test_OSAL_PrintfEnable.c


${TESTDIR}/tests/test_OSAL_Read.o: tests/test_OSAL_Read.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Read.o tests/test_OSAL_Read.c


${TESTDIR}/tests/test_OSAL_Remove.o: tests/test_OSAL_Remove.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Remove.o tests/test_OSAL_Remove.c


${TESTDIR}/tests/test_OSAL_Remove_Directory.o: tests/test_OSAL_Remove_Directory.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Remove_Directory.o tests/test_OSAL_Remove_Directory.c


${TESTDIR}/tests/test_OSAL_SetLocalTime.o: tests/test_OSAL_SetLocalTime.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_SetLocalTime.o tests/test_OSAL_SetLocalTime.c


${TESTDIR}/tests/test_OSAL_Write.o: tests/test_OSAL_Write.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_OSAL_Write.o tests/test_OSAL_Write.c
...
${OBJECTDIR}/Windows/OSALInit_nomain.o: ${OBJECTDIR}/Windows/OSALInit.o Windows/OSALInit.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/OSALInit_nomain.o Windows/OSALInit.c;\
	else  \
...
${OBJECTDIR}/Windows/clock_nomain.o: ${OBJECTDIR}/Windows/clock.o Windows/clock.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/clock_nomain.o Windows/clock.c;\
	else  \
...
${OBJECTDIR}/Windows/console_nomain.o: ${OBJECTDIR}/Windows/console.o Windows/console.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/console_nomain.o Windows/console.c;\
	else  \
...
${OBJECTDIR}/Windows/filesystem_nomain.o: ${OBJECTDIR}/Windows/filesystem.o Windows/filesystem.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Windows/filesystem_nomain.o Windows/filesystem.c;\
	else  \
